...
function getSiswaJurnalByKelas(k) { return CoreSystem.getSiswaJurnalByKelas(k, _sid()); }
function getPilihanRekapKehadiranJurnalGuru(n) { return CoreSystem.getPilihanRekapKehadiranJurnalGuru(n, _sid()); }
function getRekapKehadiranJurnalGuru(n, filter) { return CoreSystem.getRekapKehadiranJurnalGuru(n, filter || {}, _sid()); }
